...
test("prints a pryamid for n = 2", () => {
  pyramid(2);
  expect((console.log as any).mock.calls[0][0]).toEqual(" # ");
  expect((console.log as any).mock.calls[1][0]).toEqual("###");
...
test("prints a pryamid for n = 3", () => {
  ...
  expect((console.log as any).mock.calls[0][0]).toEqual("  #  ");
  expect((console.log as any).mock.calls[1][0]).toEqual(" ### ");
  expect((console.log as any).mock.calls[2][0]).toEqual("#####");
...
test("prints a pryamid for n = 4", () => {
  ...
  expect((console.log as any).mock.calls[1][0]).toEqual("  ###  ");
  expect((console.log as any).mock.calls[2][0]).toEqual(" ##### ");
  expect((console.log as any).mock.calls[3][0]).toEqual("#######");
